...
var _router = _interopRequireDefault(__webpack_require__(/*! ./router */ 16));

var _uniSimpleRouter = __webpack_require__(/*! uni-simple-router */ 17);

var _common = __webpack_require__(/*! @/common */ 47);
...
// Vue.use(uView)
// 通用业务逻辑挂载
_vue.default.use(_common.COMMON);

var app = new _vue.default(_objectSpread({
  mpType: 'app',
  router: _router.default,
  store: _store.default
}, _App.default)); //v1.3.5起 H5端 你应该去除原有的app.$mount();使用路由自带的渲染方式
  ...
  methods: {
    ...
    autoUpdate: function autoUpdate() {
      ...
      if (uni.canIUse('getUpdateManager')) {
        var updateManager = uni.getUpdateManager(); //1. 检查小程序是否有新版本发布
